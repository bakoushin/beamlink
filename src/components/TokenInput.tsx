    ...
    <div className={`relative ${className}`}>
      ...
      <div
        ...
        className={`
          ...
          ${
            !selectedToken
              ? "cursor-pointer bg-gradient-to-br from-violet-50/50 to-purple-50/50 dark:from-violet-950/20 dark:to-purple-950/20 hover:from-violet-50 hover:to-purple-50 dark:hover:from-violet-950/30 dark:hover:to-purple-950/30"
              : disabled
